...
namespace Supermoce
{
    public class Ghost : ISkill
    {
        ...
        [
            ...
            "weapon_m4a1", "weapon_m4a1_silencer", "weapon_famas", "weapon_galilar",
            "weapon_aug", "weapon_sg556", "weapon_mp9", "weapon_mac10",
        ...
        {
            SkillUtils.RegisterSkill(skillName, "Niewidka", "Jesteś niewidzialny i niesłyszalny ALE widać cię na radarze i nie możesz strzelać", "#FFFFFF", 1);
        }
