...
namespace jRandomSkills
{
    public class Phoenix : ISkill
    {
        ...
        public class SkillConfig(Skills skill = skillName, bool active = true, string color = "#ff5C0A", CsTeam onlyTeam = CsTeam.None, bool needsTeammates = false, float chanceFrom = .3f, float chanceTo = .6f) : Config.DefaultSkillInfo(skill, active, color, onlyTeam, needsTeammates)
        {
