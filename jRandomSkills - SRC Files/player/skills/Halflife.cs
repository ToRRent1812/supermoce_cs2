...
{
    public class Halflife : ISkill
    {
        private const Skills skillName = Skills.Halflife;

        public static void LoadSkill()
        {
            SkillUtils.RegisterSkill(skillName, "Half-Life", "Wybierasz gracza, który straci połowę zdrowia", "#e6b821");
        }
        ...
        public static void TypeSkill(CCSPlayerController player, string[] commands)
        {
            ...
            enemy.PrintToChat($"Wróg usunął Ci połowę zdrowia.");
        }
