...
namespace jRandomSkills
{
    public class SoundMaker : ISkill
    {
        ...
        {
            var soundToMake = "";
            if (player.Team == CsTeam.Terrorist) soundToMake = $"c4.initiate";
            else if (player.Team == CsTeam.CounterTerrorist) soundToMake = $"c4.disarmstart";
        ...
        public class SkillConfig(Skills skill = skillName, bool active = true, string color = "#e3ed8c", CsTeam onlyTeam = CsTeam.None, bool needsTeammates = false) : Config.DefaultSkillInfo(skill, active, color, onlyTeam, needsTeammates)
        {
        }
    }
}