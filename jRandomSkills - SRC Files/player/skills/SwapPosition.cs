...
namespace jRandomSkills
{
    public class SwapPosition : ISkill
    {
        ...
        private static void TeleportPlayers(CCSPlayerController attacker, CCSPlayerController victim)
        {
            ...
            QAngle attackerAngles = new(attackerPawn.AbsRotation.X, Instance.Random.Next(10,350), attackerPawn.AbsRotation.Z);
            ...
            QAngle victimAngles = new(victimPawn.AbsRotation.X, Instance.Random.Next(10,350), victimPawn.AbsRotation.Z);
