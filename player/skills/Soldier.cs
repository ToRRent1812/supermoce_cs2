...
namespace jRandomSkills
{
    public class Soldier : ISkill
    {
        ...
        public class SkillConfig(Skills skill = skillName, bool active = true, string color = "#09ba00", CsTeam onlyTeam = CsTeam.None, bool needsTeammates = false, float chanceFrom = 1.2f, float chanceTo = 1.75f) : Config.DefaultSkillInfo(skill, active, color, onlyTeam, needsTeammates)
        {
