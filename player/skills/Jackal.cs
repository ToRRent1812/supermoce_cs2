...
namespace jRandomSkills
{
    public class Jackal : ISkill
    {
        ...
        public class SkillConfig(Skills skill = skillName, bool active = true, string color = "#f542ef", CsTeam onlyTeam = CsTeam.None, bool needsTeammates = false, int maxStepBeam = 70) : Config.DefaultSkillInfo(skill, active, color, onlyTeam, needsTeammates)
        {
